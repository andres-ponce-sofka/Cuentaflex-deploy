...
@RestController
@RequestMapping(AccountEndpointsConstants.ONLINE_PURCHASE_TO_ACCOUNT_URL)
@Tag(name = "Account Purchases")
public final class PurchaseOnlineEndpoint {
    private final PurchaseOnlineUseCase purchaseOnlineUseCase;
    ...
    public PurchaseOnlineEndpoint(PurchaseOnlineUseCase purchaseOnlineUseCase) {
        this.purchaseOnlineUseCase = purchaseOnlineUseCase;
    }
    ...
    public ResponseEntity<DinResponse<TransactionDoneDto>>  purchase(
        ...
        ResultWith<TransactionDoneResponse> result = this.purchaseOnlineUseCase.execute(request);
