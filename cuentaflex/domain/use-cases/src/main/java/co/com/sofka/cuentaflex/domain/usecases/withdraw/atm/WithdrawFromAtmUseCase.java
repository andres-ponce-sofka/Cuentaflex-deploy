package co.com.sofka.cuentaflex.domain.usecases.withdraw.atm;
...
public final class WithdrawFromAtmUseCase implements UseCase<UnidirectionalTransactionRequest, ResultWith<TransactionDoneResponse>> {
    private final AccountRepository accountRepository;
    private final FeesValues feesValues;

    public WithdrawFromAtmUseCase(AccountRepository accountRepository, FeesValues feesValues) {
    ...
    public ResultWith<TransactionDoneResponse> execute(UnidirectionalTransactionRequest request) {
        ...
        BigDecimal fee = this.feesValues.getWithdrawFromAtmFee();
